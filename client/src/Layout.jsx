        ...
        <div className="row clearfix">
          <div className="col-lg-12">
            <div className="card chat-app">
              <div id="plist" className="people-list" style={{ height: 550 }}>
                ...
                <ul className="list-unstyled chat-list mt-2 mb-0 scrollable-list">
                  {conversations.map((c) => (
                    ...
                    <ul className="m-b-0">
                      {messages.map((m) => (
                        <div key={m.id} ref={scrollRef}>
                          <Message own={m.sender === user.id} messages={m} />
                        </div>
                      ))}
                    </ul>
                  </div>
                    ...
                    <div className="input-group mb-0">
                      <form className="d-flex">
                        <input
                          ...
                          onChange={(ev) => setNewMessages(ev.target.value)}
                          value={newMessages}
                          style={{ width: "900px" }}
                        />
                        <div className="input-group-prepend">
              ...
              {!currentChat && (
                <div className="chat ">
                  ...
                  <div className="chat-history">
                    <ul className="m-b-0 text-center p-5 m-5 text-secondary h1 border">
                      Open a conversation
                    </ul>
                  </div>
                  <div className="chat-message clearfix">
                    <div className="input-group mb-0">
                      <input
                        type="text"
                        className="form-control"
                        placeholder="Open a chat first"
                        disabled
                      />
                      <div className="input-group-prepend">
                        <span className="input-group-text btn btn-outline-success">
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="25"
                            height="25"
